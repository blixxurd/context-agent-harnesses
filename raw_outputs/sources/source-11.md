...
Retrieval note: Fetched via WebFetch on 2026-06-14. The original URL (docs.anthropic.com) issued a 301 redirect to https://platform.claude.com/docs/en/api/messages-streaming, which was followed. Content below is the extracted page text/markdown (code samples in multiple SDK languages have been trimmed where redundant; key SSE response examples preserved).
...
Sample prompt: "Your previous response was interrupted and ended with [previous_response]. Continue from where you left off."
